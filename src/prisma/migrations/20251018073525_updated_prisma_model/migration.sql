/*
  ...
  - You are about to drop the column `bookingAmt` on the `booking` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `booking` DROP COLUMN `bookingAmt`,
    DROP COLUMN `bookingStatus`,
    DROP COLUMN `idempotencyKeyId`,
    DROP COLUMN `hotelId`,
    DROP COLUMN `totalGuest`,
